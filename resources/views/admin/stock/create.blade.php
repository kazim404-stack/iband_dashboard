    ...
    @endphp
    <div class="modal modal-blur fade" id="create-stock" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.stock.store') }}" enctype="multipart/form-data"
                                        ...
                                        @if ($productVariants->count() > 0)
                                            @foreach ($productVariants as $productVariant)
                                                <option value="{{ $productVariant->id }}">
                                                    {{ $productVariant->product->getTranslation('name', app()->getLocale()) }}
                                                </option>
                                            @endforeach
                                        @else
                                            <option value="">No Product Variant found</option>
                                        @endif
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary ms-auto" data-bs-dismiss="modal" id="store-stock">
