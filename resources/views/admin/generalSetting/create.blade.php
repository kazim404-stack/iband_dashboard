    <div class="modal modal-blur fade" id="create-general-setting" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.general-settings.store') }}"
                     enctype="multipart/form-data" id="create-general-setting-form">
                     @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
